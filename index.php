                                ...
                                <div class="row">
                                        ...
                                        <div id="sp-top1">
                                            <div class="sp-column text-center text-lg-left">
                                                ...
                                                <ul class="sp-contact-info">
                                                    <li class="sp-contact-email"><a href="mailto:info@cobra-corp.ru"><span
                                                                class="fa fa-regular fa-envelope" aria-hidden="true"></span> <span
                                                                class="sp-contact-content">info@cobra-corp.ru</span></a></li>
                                                    <li class="sp-contact-phone"><a href="tel:+79688984378"><span
                                                                class="fa fa-phone" aria-hidden="true"></span> <span
                                                                class="sp-contact-content">+7 (968) 898-43-78</span></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div id="sp-logo" class="col-auto col-lg-2">
                                        <div class="sp-column"><a id="offcanvas-toggler" aria-label="Navigation"
                                            ...
                                            <div class="logo"><a href="/"><img class="logo-image d-none d-lg-inline-block"
                                                        src="/images/logo-top.svg" alt="Cobra TV"><img
                                                        class="logo-image-phone d-inline-block d-lg-none"
                                                        src="/images/logo-top.svg" alt="Cobra TV"></a></div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="col-md-6" id="">
                                                        <div id="" class="sppb-column">
                                                            <div class="sppb-column-addons">
                                                                ...
                                                                <div id="section-id-contact"
                                                                    class="sppb-section contact-widget">
                                                                    <div class="container-inner">
                                                                        <div class="container">
                                                                                                        ...
                                                                                                        <div class="sppb-media">
                                                                                                            <div class="pull-left">
                                                                                                                <div class="sppb-icon">
                                                                                                                    <span
                                                                                                                        class="sppb-icon-container"
                                                                                                                        aria-label="info@cobra-corp.ru"><i
                                                                                                                            class="fas fa-envelope-open"
                                                                                                                            aria-hidden="true"></i></span>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            <div
                                                                                                                class="sppb-media-body">
                                                                                                                <div class="sppb-media-content">
                                                                                                                    <h3 class="sppb-addon-title sppb-feature-box-title sppb-media-heading">
                                                            ...
                                                            <div class="sppb-container-inner">
                                                                <div class="sppb-row">
                                                                    <div class="sppb-col-md-12"
                                                                        id="column-wrap-id-1559040938642">
                                                                        <div id="column-id-1559040938642" class="sppb-column">
                                                                            <div class="sppb-column-addons">
                                                                                <div id="sppb-addon-wrapper-1559040938646"
                                                                                    class="sppb-addon-wrapper">
                                                                                    <div id="sppb-addon-1559040938646"
                                                                                        class="clearfix ">
                                                                                        <div
